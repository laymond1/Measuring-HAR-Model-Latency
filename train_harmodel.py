...
parser = argparse.ArgumentParser("HAR Model Training")
...
if args.save == 'EXP':
    ...
    args.save = 'result_harmodel/{dataset}/{arch}/trial-{trial}'.format(dataset=args.dataset, arch=args.arch, trial=args.trial)
