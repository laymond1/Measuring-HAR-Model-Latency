...
class EfficientNet(nn.Module):
    def __init__(
        ...
        **kwargs: Any,
        ...
        layers.append(
            Conv1dNormActivation(
                init_channels, firstconv_output_channels, kernel_size=3, stride=2, norm_layer=norm_layer, activation_layer=nn.SiLU
            )
        )
...
def _efficientnet(
    ...
    **kwargs: Any,
    ...
    model = EfficientNet(init_channels, inverted_residual_setting, dropout, last_channel=last_channel, **kwargs)
...
def efficientnet_b0(
    *, init_channels: int, **kwargs: Any
    ...
    return _efficientnet(init_channels, inverted_residual_setting, 0.2, last_channel, **kwargs)
...
def efficientnet_b2(
    *, init_channels: int, **kwargs: Any
    ...
    return _efficientnet(init_channels, inverted_residual_setting, 0.3, last_channel, **kwargs)
...
def efficientnet_b4(
    *, init_channels: int, **kwargs: Any
    ...
    return _efficientnet(init_channels, inverted_residual_setting, 0.4, last_channel, **kwargs)
...
def efficientnet_v2_s(
    *, init_channels: int, **kwargs: Any
    ...
    return _efficientnet(
        ...
        0.2,
        last_channel,
        norm_layer=partial(nn.BatchNorm1d, eps=1e-03),
        **kwargs,
    )
