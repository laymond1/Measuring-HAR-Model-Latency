...
def _mobilenet_v3(
    ...
    **kwargs: Any,
    ...
    model = MobileNetV3(init_channels, inverted_residual_setting, last_channel, **kwargs)
...
def mobilenet_v3_large(
    *, init_channels: int, **kwargs: Any
    ...
    return _mobilenet_v3(init_channels, inverted_residual_setting, last_channel, **kwargs)
