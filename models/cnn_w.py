...
class RTWCNN(nn.Module):
    def __init__(self, init_channels, num_classes, segment_size):
        super(RTWCNN, self).__init__()

        n_fs = 32

        self.conv1 = BasicConv1d(init_channels, n_fs, kernel_size=7, stride=1, padding=3)
