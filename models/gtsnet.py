# This code is taken from <https://github.com/jgpark92/GTSNet/blob/main/programs/model.py>
...
class GTSNet(nn.Module):
    ...
    def __init__(self, init_channels, num_classes):
        ...
        self.stem = nn.Conv1d(init_channels, first_channels, kernel_size=3, stride=1, padding=1,bias=True) #channel extansion
