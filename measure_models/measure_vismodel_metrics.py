...
def main(args):
    ...
    input_tensor = torch.randn(batch_size, init_channels, window_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_file', type=str, default='vismodel_spec.csv', help='path to config file.')
