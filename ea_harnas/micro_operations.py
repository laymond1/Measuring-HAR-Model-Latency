...
OPS = {
    ...
    'avg_pool_3x1': lambda C, stride, affine: nn.AvgPool2d((3,1), stride=stride, padding=(1,0), count_include_pad=False),
    'avg_pool_1x3': lambda C, stride, affine: nn.AvgPool2d((1,3), stride=stride, padding=(0,1), count_include_pad=False),
    'avg_pool_3x3': lambda C, stride, affine: nn.AvgPool2d(3, stride=stride, padding=1, count_include_pad=False),
    'max_pool_3x1': lambda C, stride, affine: nn.MaxPool2d((3,1), stride=stride, padding=(1,0)),
    'max_pool_5x1': lambda C, stride, affine: nn.MaxPool2d((5,1), stride=stride, padding=(2,0)),
    'max_pool_1x3': lambda C, stride, affine: nn.MaxPool2d((1,3), stride=stride, padding=(0,1)),
    ...
    'conv_11x1' : lambda C, stride, affine: ReLUConvBN(C, C, (11,1), stride, (5,0), affine=affine),
