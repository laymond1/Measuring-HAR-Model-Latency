...
if args.save == 'EXP':
	args.save = 'result_harnas/{}/train-{}-{}'.format(args.dataset, args.save, time.strftime("%Y%m%d-%H%M%S"))
else:
    args.save = 'result_harnas/{dataset}/{arch}/trial-{trial}'.format(dataset=args.dataset, arch=args.arch, trial=args.trial)
